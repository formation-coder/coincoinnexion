<?php
    $user = $_GET['login']; // Comme le formulaire est soumis avec la méthode get, on utilise le tableau $_GET pour récupérer les valeurs des champs du formulaire
    $pass = $_GET['password']; // On a le mot de passe saisi par l'utilisateur
